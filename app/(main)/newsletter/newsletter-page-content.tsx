...
const englishCopy = {
    ...
    joinBody: 'Subscribe for new articles, curated tooling, and operator-grade workflows.',
...
const vietnameseCopy = {
    ...
    joinBody: 'Đăng ký để nhận bài mới, công cụ đáng chú ý và workflow dành cho người vận hành hệ thống.',
    buttonLabel: 'Nhận bản tin',
    helperText: 'Chúng mình chỉ gửi các cập nhật hữu ích và các bài viết đủ chất lượng để đọc thật.',
...
export function NewsletterPageContent({ locale = 'vi' }: NewsletterPageContentProps) {
            ...
            <section className="relative overflow-hidden rounded-[32px] bg-slate-950 px-6 py-10 text-white shadow-xl md:px-10 md:py-14">
                ...
                <div className="relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                    ...
                    <div className="rounded-[28px] border border-white/10 bg-white/10 p-6 backdrop-blur">
                        ...
                        <p className="mt-2 text-sm leading-6 text-slate-300">{copy.joinBody}</p>
