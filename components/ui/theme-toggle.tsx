...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="inline-flex size-10 items-center justify-center rounded-2xl border text-sm font-semibold transition-all active:scale-95 theme-panel-muted theme-border-ghost text-[color:var(--text-muted-theme)] hover:text-[color:var(--text-main-theme)]"
